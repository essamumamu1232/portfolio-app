      ...
      <div className="container">
        ...
        <div className="contact-cards-grid">
          ...
          <div className="contact-card">
            ...
            <p className="contact-card-desc">Best for detailed project proposals and contract inquiries.</p>
            <div className="contact-card-actions">
              <a 
                href="mailto:essammubbashirbusiness@gmail.com" 
                className="btn btn-primary btn-sm"
              >
                Send Email <ArrowRight size={14} />
              </a>
              <button 
                onClick={() => handleCopy('essammubbashirbusiness@gmail.com', 'email')}
          ...
          <div className="contact-card highlight">
            ...
            <div className="contact-card-tag">Fastest Response</div>
            <h3>Phone & WhatsApp</h3>
            <p className="contact-card-value">+92 336 2243778</p>
            <p className="contact-card-desc">Available for direct calls, SMS, and WhatsApp messages.</p>
            <div className="contact-card-actions">
              <a 
                href="https://wa.me/923362243778" 
                target="_blank" 
                rel="noreferrer" 
                className="btn btn-primary btn-sm"
              >
          ...
          {/* GitHub & Code Review Card */}
          <div className="contact-card">
            <div className="contact-card-icon">
              <Github size={24} />
            </div>
            <h3>GitHub & Code Review</h3>
            <p className="contact-card-value">github.com/essamumamu1232</p>
            <p className="contact-card-desc">Explore repositories, view code commits, or request a technical review.</p>
            <div className="contact-card-actions">
              <a 
                href="https://github.com/essamumamu1232" 
                target="_blank" 
                rel="noreferrer" 
                className="btn btn-primary btn-sm"
              >
              ...
              <button 
                onClick={() => handleCopy('https://github.com/essamumamu1232', 'github')}
                className="btn btn-ghost btn-sm"
                title="Copy Link"
              >
